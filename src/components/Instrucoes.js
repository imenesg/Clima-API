...
function Instrucoes(){
    return(
        ...
        <div className="instrucoes">
            <h2>🖐️Esse é um projeto feito Usando React.js e a API do site <a target="_blank" href="https://www.weatherapi.com/" className="link">Weatherapi</a>.</h2>
            ...
            <p>O código está no repoisitorio do Github☀️: <a  target="_blank" className="link" href="https://github.com/imenesg/Clima-API">github.com/imenesg/Clima-API</a>  </p>
